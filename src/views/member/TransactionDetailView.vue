      ...
      <div class="grid gap-6 lg:grid-cols-[1fr_390px]">
        <div class="space-y-6">
          ...
          <section v-if="!isPromoTransaction" class="rounded-lg border border-ink/10 bg-white p-5 shadow-soft">
            ...
            <p v-if="paymentConfig.supportContact" class="mt-4 rounded-md bg-gold/10 px-3 py-2 text-sm font-semibold text-ink">
              Butuh bantuan? Hubungi admin: {{ paymentConfig.supportContact }}.
            </p>
          </section>
        </div>
